package fhj.swengb.assignments.functional.pkoerner
...
case class FunctionalAssignment(lowerBound: Int = 1,
  ...
  /**
    ...
    * you can use sum, fold and reduce.
    */
  val sumXs = xs.foldRight(0)(_+_)
  ...
  /**
    ...
    *
    * also possible without the dot after xs and the brackets after zip
    * but for (my) better reading with everything added
    */
